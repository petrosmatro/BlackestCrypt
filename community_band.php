...
$genres = mysqli_query($conn, "SELECT * FROM artists_subgenres JOIN subgenres ON artists_subgenres.id_sub = subgenres.id_sub WHERE id_artist = $artistId");
...
<body>
    ...
    <div class="artist-preview">
        <div class="top-part">
            <img id="artist-image" src="artistImgs/<?php echo $artist['artist_image']; ?>" alt="">
            <div class="artist-title">
                <h1 id="artist-name"><?php echo $artist['artist_name']; ?></h1>
                <p id="artist-genres">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', async () =>{
            ...
            $('.rating-box').on('click', function() {
                ...
                $.ajax({
                    url: 'add_community_rating.php?id=<?php echo $artistId;?>',
                    type: 'POST',
            ...
            function loadRatings(){
                $.ajax({
                    url: 'load_community_ratings.php?id=<?php echo $artistId;?>',
                    type: 'GET',
            ...
            async function loadDescription(){
                <?php 
                    $select = "SELECT * FROM artist_descriptions WHERE artist_id = '$artistId'";
            ...
            $('#descForm').on('submit', function(event){
                ...
                $.ajax({
                    url: 'send_community_desc.php?id=<?php echo $artistId;?>',
                    type: 'POST',
            ...
            async function loadDiscography(){
                ...
                function loadAlbums() {
                    $.ajax({
                        url: 'load_community_albums.php?id=<?php echo $artistId;?>',
                        type: 'GET',
                        success: function(response) {
            ...
            async function loadCommentsContent(){
                contentDiv.innerHTML = `
                    ...
                    $('#commentForm').on('submit', function(event) {
                        ...
                        $.ajax({
                            url: 'add_community_comment.php?id=<?php echo $artistId; ?>',
                            type: 'POST',
                    ...
                    function loadComments() {
                        $.ajax({
                            url: 'load_community_comments.php?id=<?php echo $artistId;?>',
                            type: 'GET',
                            success: function(response) {
